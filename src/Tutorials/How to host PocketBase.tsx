...
export default function HostPocketBase() {
  useEffect(() => {
    document.title = "How to host PocketBase";
  }, []);
...
const pb = new PocketBase('https://xxxxx.pocketcloud.xyz');`;
  ...
  return (
    <>
      <Navbar />
      <div className="px-24">
        <h1 className="text-4xl py-16 font-bold">How to host PocketBase</h1>
        <p className="pb-8">
          PocketBase by itself is self-hosted only, i.e. it does not provide a built-in
          hosting service. Which means you need some external setup to host your
          PocketBase instance, so your web app can access it in production. This process
          is usually very complicated and time consuming. This tutorial will walk you
          through an easy way to host your PocketBase instance.
        </p>
        <p className="pb-8">
          We will be using{" "}
          ...
          , which is a platform that makes it very easy to host PocketBase.
        </p>
